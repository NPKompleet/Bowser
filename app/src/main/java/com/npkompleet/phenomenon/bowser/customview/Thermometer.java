package com.npkompleet.phenomenon.bowser.customview;
...
import com.npkompleet.phenomenon.bowser.utils.Utils;
...
public class Thermometer extends View {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        showGraduation = typedArray.getBoolean(R.styleable.Thermometer_showGraduation, Boolean.FALSE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (tmp <= innerEffectEndY && showGraduation) {
